...
try:
    df_export = pd.read_csv(os.path.join(pathlib.Path().parent.absolute(), f'{yt_channel}_full.csv'))
except:
    print(f'There isn\'t a {yt_channel}_full.csv')
    sys.exit(1)
# df_export = df_export.iloc[37:40,:]
subscribers = '2.34M'
...
# print(df_export['Date'].head())
# print(df_export['Date'].dtype)
